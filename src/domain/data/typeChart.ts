// Gen 6+ type effectiveness chart (stable since 2013).
// KEY = attacking type, VALUE = defending types whose multiplier is not ×1.
// Absence from a defending entry implies ×1.
import type { PokemonType } from '../entities/Pokemon';

export const TYPE_CHART: Record<PokemonType, Partial<Record<PokemonType, 0 | 0.5 | 2>>> = {
