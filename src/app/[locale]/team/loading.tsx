  ...
  return (
    <div className="min-h-dvh">
      <header className="mx-auto max-w-7xl px-4 pb-4 pt-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-1 h-4 w-72 animate-pulse rounded-full bg-stone-100" />
      </header>
      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 h-12 animate-pulse rounded-xl bg-stone-100" />

        <div className="mt-8 h-6 w-40 animate-pulse rounded-full bg-stone-200" />
