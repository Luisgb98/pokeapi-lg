  ...
  return (
    <div className="relative overflow-hidden">
      <div className={`relative pb-8 pt-6 ${tc.gradientBg}`}>
        <div className="pointer-events-none absolute inset-0 hidden dark:block dark:bg-stone-950/80" />
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <Link
            href={backHref}
            className="inline-flex items-center gap-1.5 rounded-xl px-3 py-1.5 text-sm font-medium text-stone-600 transition-colors hover:bg-white/60 hover:text-stone-900 dark:text-stone-300 dark:hover:bg-black/20 dark:hover:text-stone-100"
          >
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-center px-4 pt-4 sm:flex-row sm:items-end sm:gap-8 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 text-center sm:mt-0 sm:pb-4 sm:text-left">
            <p className="mb-1 font-mono text-sm font-medium tracking-widest text-stone-400 dark:text-stone-400">
              {formattedId}
            </p>
